    ...
    case "HU":
      switch (component.toString().toUpperCase()) {
        ...
        case "ABOUT":
          return {
            description:
              "A Somnia Co. csapatának tervezői tipikusan extravagáns, minimalista stílusú termékek tervezési formáját és mintáját követik, ezáltal haladva a mindennapi, de mégis különleges, fiatalos divatvonallal. Térjen vissza a főoldalra, és nézzen szét bátran termékeink között!",
            previous: "Előző oldal",
